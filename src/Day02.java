...
public class Day02 {
    ...
    private void doPart1(String input) {
        ...
        while (sc.hasNextLine()) {
            ...
            List<String> lineItems = Arrays.asList(line.split("\\s+")); // split on 1 or more whitespace

            if (isListValid(lineItems)) {
                totalSafeReports++;
            }
        }
        System.out.println("Part 1: " + totalSafeReports);
    }
    ...
    private void doPart2(String input) {
        ...
        while (sc.hasNextLine()) {
            String line = sc.nextLine();
            List<String> lineItems = new ArrayList<>(Arrays.asList(line.split("\\s+"))); // split on 1 or more whitespace

            boolean isListValid = isListValid(lineItems);
            if (!isListValid) {
                for (int i = 0; i < lineItems.size(); i++) {
                    List<String> toCheck = new ArrayList<>(lineItems);
                    toCheck.remove(i);
                    isListValid |= isListValid(toCheck);
                }
            }
        ...
        System.out.println("Part 2: " + totalSafeReports);
    }
    ...
    private boolean isListValid(List<String> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (i == 1) {
                isDecreasing = item < previousItem;
            }
